//###########################################################################
//
// FILE:   f28002x_examples.h
//
// TITLE:  f28002x Device Definitions.
//
//###########################################################################
...
#ifndef F28002x_EXAMPLES_H
#define F28002x_EXAMPLES_H
...
#define   AUXPLLRAWCLK_BY_3    4
#define   AUXPLLRAWCLK_BY_5    5
#define   AUXPLLRAWCLK_BY_6    6
#define   AUXPLLRAWCLK_BY_7    7
//
// The following are values that can be passed to the
...
/*-----------------------------------------------------------------------------
    ...
    Example:   160 MHz devices:
             CLKIN is a 20 MHz crystal 

             In step 1 the user specified the PLL multiplier = 0x8 for a
             160 MHz CPU clock (SYSCLKOUT = 160 MHz).

             In this case, the CPU_RATE will be 6.25L
             Uncomment the line: #define CPU_RATE 6.25L

-----------------------------------------------------------------------------*/
#define CPU_RATE   6.25L   // for a 160MHz CPU clock speed (SYSCLKOUT)
...
// Includes
//
#include "f28002x_globalprototypes.h"       // Prototypes for global functions
                                           // within the .c files.
#include "f28002x_adc_defines.h"
#include "f28002x_cputimervars.h"
#include "f28002x_gpio_defines.h"           // Macros used for GPIO support code
#include "f28002x_pie_defines.h"            // Macros used for PIE examples.
#include "f28002x_sysctrl_defines.h"        // Macros used for LPM support code
#include "f28002x_dma_defines.h"        // Macros used for DMA support code
#include "f28002x_epwm_defines.h"           // Macros used for PWM examples.
...
//
#define DELAY_US(A)  F28x_usDelay((((long double)A * 1000.0L) / (long double)CPU_RATE) - 15.0L)         // reference range A: 16 ~ 26214
...
#endif  // end of F28002x_EXAMPLES_H definition
