...
//#define FMSTR_SCIDR_OFFSET 7
    ...
    /* SCI module registers  HX28034*/
    #define FMSTR_SCIBDH_OFFSET 0
    #define FMSTR_SCIBDL_OFFSET 1
    #define FMSTR_SCIC1_OFFSET 2
    #define FMSTR_SCIC2_OFFSET 0x10
    #define FMSTR_SCIS1_OFFSET 0X14
    #define FMSTR_SCIS2_OFFSET 5
    #define FMSTR_SCIC3_OFFSET 6
    #define FMSTR_SCIDR_OFFSET 0x20
...
#define FMSTR_SCIC2_TE        0x01
#define FMSTR_SCIC2_RE        0x02
...
/* SCI module registers HX28034*/
#define FMSTR_SCIBAUD_OFFSET 0x08
#define FMSTR_SCISTATUS_OFFSET 0x14
#define FMSTR_SCICTRL_OFFSET 0x04
...
//#define FMSTR_SCICTRL_RIE       0x200000
    ...
    /* SCI Control Register bits HX28034*/
    #define FMSTR_SCICTRL_TE        0x020000
    #define FMSTR_SCICTRL_RE        0x010000
    #define FMSTR_SCICTRL_TIE       0x010000
    #define FMSTR_SCICTRL_TCIE      0x400000
    #define FMSTR_SCICTRL_RIE       0x020000
...
#define FMSTR_SCI_TE() SciaRegs.SCICTL1.bit.TXENA = 1//FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_TE)
#define FMSTR_SCI_TD() SciaRegs.SCICTL1.bit.TXENA = 0//FMSTR_CLRBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_TE)
...
#define FMSTR_SCI_RE() SciaRegs.SCICTL1.bit.RXENA = 1//FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RE)
#define FMSTR_SCI_RD() SciaRegs.SCICTL1.bit.RXENA = 0//FMSTR_CLRBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RE)

//#define FMSTR_SCI_TE_RE() FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RE | FMSTR_SCIC2_TE)
#define FMSTR_SCI_TE_RE() SciaRegs.SCICTL1.bit.TXENA = 1; SciaRegs.SCICTL1.bit.RXENA = 1
    //FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RE | FMSTR_SCIC2_TE)
...
//#define FMSTR_SCI_DTXI() FMSTR_CLRBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_TIE)
    ...
    #define FMSTR_SCI_ETXI() SciaRegs.SCICTL2.bit.TXINTENA = 1//FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_TIE)
    #define FMSTR_SCI_DTXI() SciaRegs.SCICTL2.bit.TXINTENA = 0//FMSTR_CLRBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_TIE)
...
//#define FMSTR_SCI_DRXI() FMSTR_CLRBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RIE)
    ...
    #define FMSTR_SCI_ERXI() SciaRegs.SCICTL2.bit.RXBKINTENA = 1 //FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RIE)
    #define FMSTR_SCI_DRXI() SciaRegs.SCICTL2.bit.RXBKINTENA = 0 //FMSTR_CLRBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RIE)


/* Tranmsit character */
//#define FMSTR_SCI_PUTCHAR(ch) FMSTR_SETREG8(FMSTR_SCI_BASE, FMSTR_SCIDR_OFFSET, ch)
#define FMSTR_SCI_PUTCHAR(ch)  Scia_Send(ch)

/* Get received character */
//#define FMSTR_SCI_GETCHAR() FMSTR_GETREG8(FMSTR_SCI_BASE, FMSTR_SCIDR_OFFSET)
#define FMSTR_SCI_GETCHAR()  SciaRegs.SCIRXBUF.bit.SAR
...
#define FMSTR_SCI_RDCLRSR() SciaRegs.SCICTL2.bit.TXRDY
    #else
